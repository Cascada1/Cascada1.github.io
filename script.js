...
function randomQuote() {
  ...
  var i = Math.floor(Math.random() * (102 - 0 + 1)) + 0;
  ...
  back[4]="url('https://i.ytimg.com/vi/dygfsoyijVo/hqdefault.jpg')"  
  back[3]="url('https://i.ytimg.com/vi/Q2-0w0YrsfA/maxresdefault.jpg')" 
  ...
  back[12]="url('http://www.travel-visit-places.com/wp-content/uploads/Golden-Waters-Great-Smoky-Mountains-National-Park-Tennessee.jpg')"  
  ...
  back[5]="url('http://images.akamai.steamusercontent.com/ugc/25087975291817161/4B01A1274CA990A3577CC37E1DAA72F88DE353F8/')" 
  back[11]="url('http://www.lf.k12.de.us/wp-content/uploads/2015/03/Sports.png')" 
  ...
  back[16]="url('http://cdn.shopify.com/s/files/1/0603/4549/files/sheet-market-fall-destination-locations-blog.jpg?1683')" 
  back[7]="url('https://www.eugene-or.gov/ImageRepository/Document?documentID=23417')" 
  ...
  back[13]="url('http://www.englishchat247.com/wp-content/uploads/2015/03/009-weather-1.jpg')"
    document.body.style.backgroundImage=back[pp];
   if(pp==0){ document.getElementById("0").style.color="black";document.getElementById("1").style.color="black";$('h1').hide();
            document.getElementById("0").style.marginTop="70px";}
   if(pp==8){ document.getElementById("0").style.color="white";document.getElementById("1").style.color="white";}
    if(pp==8){ document.getElementById("a1").style.backgroundColor="rgba(100,80,180,0.1)"}
                     }
  ...
  array[65] = "If you tell the truth, you don't have to remember anything."
  ...
  array[102] = "Choose a job you love, and you will never have to work a day in your life."
  
  

 setTimeout(function(){document.getElementById("0").innerHTML = array[i];}, 100); 
  ...
  setTimeout(function(){document.getElementById("1").innerHTML = sub[i];}, 100);
